...
<body>
	 ...
	 <h1>修改学生信息
            <span>注意：学号不能被修改</span>
        </h1>
        <label><span>学号：</span><input type="text" name="studentId" value="${student.studentId}" readonly></label>
        <label><span>姓名：</span><input type="text" name="studentName" value="${student.studentName}"></label>
        <label><span>性别：</span><select name="sex">
                        <option value="男">男</option>
                        <option value="女">女</option>
                    </select></label>
        <label><span>班级：</span><select name="className">
